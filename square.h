...
struct square {
    ...
    square(const vertex<T>& a, const vertex<T>& b, const vertex<T>& c, const vertex<T>& d);
...
template<class T>
square<T>::square(const vertex<T>& a, const vertex<T>& b, const vertex<T>& c, const vertex<T>& d) {
    vertices[0] = a;
    vertices[1] = b;
    vertices[2] = c;
    vertices[3] = d;
